<template>
  <div class="space-y-6">
    <UiCard card-class="overflow-hidden border-white/10 bg-gradient-to-br from-highlight/12 via-white/5 to-accent/12 shadow-md">
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 class="font-display bg-gradient-to-r from-highlight to-accent bg-clip-text text-2xl font-bold text-transparent md:text-3xl">Ulasan Talent</h1>
    ...
    <section class="grid gap-4 sm:grid-cols-2">
      <UiCard title="Rating Rata-rata" description="Rata-rata rating semua review.">
        <p class="text-2xl font-semibold text-ui-light">{{ averageRatingLabel }}</p>
      </UiCard>

      <UiCard title="Total Ulasan" description="Jumlah review dari organizer.">
...
useState('talent-layout-title', () => 'Dashboard Talent').value = 'Ulasan';
