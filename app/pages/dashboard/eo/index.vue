...
const { data: events, pending: eventsPending, deleteEvent } = useEoEvents();
const { data: bookings, pending: bookingsPending, completeBooking, cancelBooking } = useEoBookings();
