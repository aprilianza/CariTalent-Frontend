...
const props = withDefaults(
  ...
  }>(),
  {
    links: () => [
      ...
      { label: 'Event', to: '/dashboard/talent/events', icon: 'mdi:calendar-search-outline' },
      ...
      { label: 'Pemesanan', to: '/dashboard/talent/bookings', icon: 'mdi:calendar-check-outline' },
      { label: 'Ulasan', to: '/dashboard/talent/reviews', icon: 'mdi:star-outline' },
      { label: 'Profil', to: '/dashboard/talent/profile', icon: 'mdi:account-circle-outline' },
    ],
    headerTitle: 'CariTalent',
    headerSubtitle: 'Workspace Talent',
